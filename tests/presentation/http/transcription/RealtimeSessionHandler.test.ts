...
jest.mock(
  "../../../../api/src/application/use-cases/transcription/CreateRealtimeSessionUseCase",
  () => ({
...
import { handler } from "../../../../api/src/presentation/http/transcription/RealtimeSessionHandler";
